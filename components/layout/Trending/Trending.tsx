    ...
    return (
        <section className="mt-2 px-4 sm:px-6 lg:px-8">
            <div className="bg-primary max-w-7xl mx-auto rounded-md">
                <div className="relative bg-purple-100 dark:bg-purple-950 rounded-md border-2 border-primary/80 w-full h-13.5 flex items-center py-1 px-3 overflow-hidden">
                    ...
                    <div className="relative flex-1 overflow-hidden">
                        ...
                        <div className="flex gap-3 animate-trending whitespace-nowrap">
                            {items.map((item, i) => (
                                <a
                                    key={i}
                                    href={item.href}
                                    className="flex items-center gap-1 px-4 py-1 text-xs md:text-sm dark:text-gray-300 rounded-full bg-primary/10 dark:bg-purple-700 shrink-0"
                                >
                                    {item.label}
                        ...
                        {/* left blur */}
                        <div className="absolute left-0 top-0 h-full w-12 bg-linear-to-r from-purple-100 dark:from-purple-950 to-transparent pointer-events-none" />

                        {/* right blur */}
                        <div className="absolute right-0 top-0 h-full w-12 bg-linear-to-l from-purple-100 dark:from-purple-950 to-transparent pointer-events-none" />
